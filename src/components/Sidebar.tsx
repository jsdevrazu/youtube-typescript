...
export default function Sidebar() {
  ...
  return (
    <div className="hidden lg:block w-2/12 bg-[#212121] pr-5 overflow-auto pb-8 sidebar">
      <ul className="flex flex-col border-b-2 border-gray-700">
        {mainLinks.map(({ icon, name }) => {
          return (
            ...
            >
              <a href="https://www.youtube.com/channel/UCv54fMK_UR7SJX70W02usaA" rel="noreferrer" target="_blank" className="flex items-center gap-5">
                {icon}
